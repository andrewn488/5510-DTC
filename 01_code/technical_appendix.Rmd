...
costPerLead <- GLSourceGrouping %>%
  ...
  mutate(costPerLead = DifferenceDebitCredit/countLead,
         costPerResident = costPerLead * ResidentRate)
...
costPerYear <- GLYearGrouping %>%
  ...
  mutate(costPerLeadYear = DifferenceDebitCredit/countLead,
  costPerResidentYear = costPerLeadYear* ResidentRate)
...
costPerSeason <- GLSeasonGrouping %>%
  ...
  mutate(costPerLeadSeason = DifferenceDebitCredit/countLead,
  costPerResidentSeason = costPerLeadSeason* ResidentRate)
...
costPerPropertyType <- GLPropertyTypeGrouping %>%
  ...
  mutate(costPerLeadProperty = DifferenceDebitCredit/countLeadPropertyType,
  costPerPropertyType = costPerLeadProperty * ResidentRate)
...
costPerCounty <- GLCountyGrouping %>%
  ...
  mutate(costPerLeadCounty = DifferenceDebitCredit/countLeadCounty,
  costPerCounty = costPerLeadCounty * ResidentRate)
```
