...
```{r Group by Source}
##trying to group by (Person/Description or Remarks) on ledger base so I can get 

##sqldf('SELECT DISTINCT [Person/Description] FROM ledger_base ')

write_xlsx(ledger_base, "../02_raw_data/ledger_base")


sourceList <- unique(trafficReportList$Source)
source_df <- data_frame(sourceList)
write_xlsx(source_df, "../02_raw_data/sourceList")
